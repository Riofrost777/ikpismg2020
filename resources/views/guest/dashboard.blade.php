@extends('layouts.app', ['activePage' => 'dashboard', 'titlePage' => __('Guest Dashboard')])
@if(Auth::user()->position == 'ADMIN' || Auth::user()->position == 'MEMBER' || Auth::user()->position == 'GUEST' )
  @if(Auth::user()->position == 'ADMIN' || Auth::user()->position == 'MEMBER')
    {{ route('dashboard') }}
  @endif
  @else
    {{ route('login') }}
